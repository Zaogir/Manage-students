# Introduction
This program consists of being able to manage a student database that runs in RAM memory.
The program allows us to import or export our database in different formats such as json and binary.


# main.py
This is the main of the program that when it is executed will execute an infinite loop that will ask us for different options that we will be able to choose, it is a simple program that I had to make for a class project.
...
# institut.py
This is where we will have the functions that make the main.py work correctly, both files are needed for the program to work.
